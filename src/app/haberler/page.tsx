  ...
  return (
    <div className="page-flow min-h-screen bg-[var(--lale-emerald-deep)]">
      <PageHero
        ...
        description="Güzellik dünyasındaki trendler, bakım önerileri ve Dream Moon’daki yenilikleri sade ve modern bir editöryel sunumla takip edin."
        image="/dreammoon/hero.webp"
        imageAlt="Dream Moon Beauty haberler"
      />
